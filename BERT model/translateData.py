...
def translatedDataToFile(file, definitions:bool):
    ...
    for i in range(len(file)):
        ...
        if definitions == True:
            ...
            filename = "TranslatedDefinitions.csv"
            ...
            filename = "TranslatednewData.csv"
...
if __name__ == "__main__":
    ...
    featuresFile = pd.read_csv("newData.csv", sep='\t', usecols=[1, 2, 3, 4, 5, 6], encoding="utf-8")
    definitionsFile = pd.read_excel("C:\\Users\\laris\\Desktop\\GitHub\\bachelor-thesis\\Daten\\Rating_Definitionen.xlsx", usecols=[0,1,8])    # HIER CONFIG EINFÜGEN
